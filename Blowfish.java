...
public class Blowfish
{
    ...
    public static final String ENCRYPTION_SCHEME = "Blowfish";
    ...
    public Blowfish(String myEncKey) throws Exception
    {
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        System.out.println("Enter the 8 bytes key for Blowfish :");
        String Key = sc.nextLine();
        Blowfish myEncryptor = new Blowfish(Key);
